<div class="container-fluid affichage">
    ...
    <p>Evidement ce genre d'information doit être réservé à un admin et on les affiches pas mais j'ai un peu la flemme
        d'en créer un donc je le met comme ça juste pour vous montrez que je sais
