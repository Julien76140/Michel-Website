    ...
    <div class="row">
        <div class="col-lg-4 centrehab">
            <section id="deshab1" class="surligne">
                ...
                <p>Alors que l’agence spatiale européenne imagine imprimer des habitats en 3D sur la Lune, la NASA se
                    tourne vers Mars. le problème : une fois arrivés, les astronautes devront rester plusieurs semaines
                    ou mois, sur la planète rouge avant de pouvoir revenir sur Terre. Alors comment les loger pendant ce
                    temps ?</p>
            </section>
            <hr/>
        ...
        <div class="col-lg-12">
            ...
            <section id="descolo2" class="surligne">
                ...
                <p>La NASA a lancé il y quelques années un concours dont l’objectif est d’imaginer des habitations
                    martiennes imprimés en 3D avec des matériaux locaux les 18 derniers projets en lice devaient
                    proposer des modèles 3D réalistes. Les cinq lauréats viennent d’être désignés par l’agence spatiale
                    américaine. Selon les résultats obtenus, ils se partageront le prix de 100 000 dollars.</p>
            </section>
            <hr/>
        ...
        <div class="col-lg-4">
            ...
            <section id="descolo3" class="surligne">
                ...
                <iframe width="100%" height="400" src="https://www.youtube.com/embed/CZEUYKePV_0" frameborder="0"
        ...
        <div class="col-lg-4">
            ...
            <section id="descolo4" class="surligne">
                ...
                <p>Prenant la forme d’un œuf, cette structure dotée d’une double coque est parfaitement adaptée pour
                    résister aux tempêtes de poussière ou aux températures glaciales qui caractérisent la planète
                    rouge.</p><br/>
                <iframe width="100%" height="400" src="https://www.youtube.com/embed/XnrVV0w2jrE" frameborder="0"
                        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </section>
            <hr/>
        ...
        <div class="col-lg-4">
            ...
            <section id="descolo5" class="surligne">
                ...
                <iframe width="100%" height="400" src="https://www.youtube.com/embed/a_BN_xJZMOk" frameborder="0"
                        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </section>
            <hr/>
        ...
        <div class="col-lg-6">
            ...
            <section id="descolo6" class="surligne">
                ...
                <iframe width="100%" height="400" src="https://www.youtube.com/embed/Lxoqs18BOoE" frameborder="0"
                        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </section>
            <hr/>
        ...
        <div class="col-lg-6">
            ...
            <section id="descolo7" class="surligne">
                ...
                <iframe width="100%" height="400" src="https://www.youtube.com/embed/mxzoO9ADqOE" frameborder="0"
                        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </section>
            <hr/>
